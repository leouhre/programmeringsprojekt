...
extern const char empty_heart[7];
extern const char full_heart[7];
extern const char standard_gun[21][2];
extern const char missile[31][2];
extern const char nuke[36][2];
